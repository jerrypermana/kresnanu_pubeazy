...
if ($_SESSION['group_session'] == 'admin') {
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-file-text-o"></i> Add Information Content
        </h1>
    ...
    <section class="content">
            ...
            <div class="col-md-10">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-file-text-o"></i> Information</h3>
                    ...
                    <form role="form" action="" method="POST" name='simpan' class='form-horizontal form-bordered'>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="page_information" id='speaker_name' class="form-control" required>
                                </div>
                            </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            $query_content  = "INSERT INTO home_information (page_information, description, sequance, input_date)
                                        VALUES('$page_information','$description','$sequance', '$input_date')";
            ...
            if ($insert_content) {
                echo '<script>alert("Information  Pages Berhasil di Tambahkan")</script>';
            } else {
                echo '<script>alert("Information  Pages Gagal di Tambahkan")</script>';
            }
        }
