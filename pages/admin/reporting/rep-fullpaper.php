            ...
            $(document).ready(function() {
                $('#full_paper').bootstrapTable({
                    ...
                    columns: [{
                        ...
                        width: '10%',
                        formatter: function(value, row) {
                            return "<a href='<?php echo $base_url; ?>/index.php?p=hapus&paper_id=" + value + "'onClick=\"return confirm('Apakah anda yakin akan menghapus data item')\"><button type='button' class='btn btn-danger'><i class='fa fa-trash'></i> Delete</button></a>";
